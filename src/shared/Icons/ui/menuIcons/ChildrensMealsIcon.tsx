...
export const ChildrensMealsIcon = () => (
    <Icon viewBox='0 0 24 24' fill='none' w={6} h={6}>
        <path fill='url(#prefix__pattern0_5007_9576)' d='M0 0h24v24H0z' />
        <defs>
            <pattern
                id='prefix__pattern0_5007_9576'
                patternContentUnits='objectBoundingBox'
                width='1'
                height='1'
            >
                <use
                    xlinkHref='#prefix__image0_5007_9576'
                    transform='matrix(.00781 0 0 .00781 .125 .125)'
                />
            </pattern>
            <image
                id='prefix__image0_5007_9576'
                width='96'
                height='96'
